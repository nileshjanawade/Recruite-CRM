...
public class DeleteCandidatePage extends BasePage {
    ...
    public void deleteCandidate() {
        ...
        DeleteCandidate dc = new DeleteCandidate(driver);
        dc.getCandidateCheckBox().click();
        dc.getDeleteIcon().click();
        dc.getinputCountOnDeleteWindow().sendKeys("1");
        dc.getdeleteButtonOnDeleteWindow().click();
        log.info("Deleted candidate successfully");
    }
